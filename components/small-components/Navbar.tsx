...
const Navbar = () => {
    ...
    return(
        <div className="w-full h-[80px] px-4 md:px-12 bg-black flex justify-between items-center z-50">
            ...
            >
             ...
             {isMobile && isOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-70 z-40" onClick={toggleMenu}>
                    <div className="fixed inset-y-0 right-0 w-3/4 max-w-xs h-full bg-black shadow-xl z-50 flex flex-col justify-start items-center pt-20 px-4 gap-8" onClick={(e) => e.stopPropagation()}>
                        <button
